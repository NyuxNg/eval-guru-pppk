...
<script>
    ...
    function loadDataStatus(idPerangkatDaerah) {
        $.ajax({
            type: "get",
    ...
    $('#simpan').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#tutup').click();
                loadDataStatus(idPerangkatDaerah);
    ...
    $('#cari').click(function (e) {
        ...
        loadDataStatus(cari_perangkatdaerah);
    ...
    $(document).on('click','.edit-status', function () {
        let id = $(this).attr('id');
        let idPerangkatDaerah = $('#cari_perangkatdaerah').val();
        $.ajax({
            type: "get",
