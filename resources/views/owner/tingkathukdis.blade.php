<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Master Tingkat Hukuman Disiplin') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="card card-success">
            <div class="card-header">
                Daftar Tingkat Hukuman Disiplin
            ...
            <div class="card-body">
                <table id="tabelTingkathukdis" class="table table-bordered table-inverse table-xs">
            ...
            <div class="card-footer text-muted">
                <button id="tambah" type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#modelId">
                    Tambah Tingkat Hukuman Disiplin
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><strong> Tambah Tingkat Hukuman Disiplin</strong></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nama">Tingkat Hukuman Disiplin</label>
    ...
    $('#simpan').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#tabelTingkathukdis').DataTable().ajax.reload(null, false);
                $('#simpan').text('Save');
