<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Master Data Jenis Kenaikan Pangkat') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="card card-success">
            ...
            <div class="card-body">
                <table id="tabelJeniskp" class="table table-bordered table-inverse table-xs">
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><strong> Tambah Jenis Kenaikan Pangkat</strong></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nama">Jenis Kenaikan Pangkat</label>
    ...
    $('#simpan').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#tabelJeniskp').DataTable().ajax.reload(null, false);
                $('#simpan').text('Save');
