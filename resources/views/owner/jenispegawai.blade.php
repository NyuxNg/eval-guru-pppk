<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Master Data Jenis Kepegawaian') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="card card-success">
            ...
            <div class="card-body">
                <table id="tabelJenispegawai" class="table table-bordered table-inverse table-xs">
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><strong> Tambah Jenis Kepegawaian</strong></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nama">Nama Jenis Kepegawaian</label>
                        <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan nama jenis kepegawaian">
                    </div>
                    <div class="form-group">
    ...
    $('#simpan').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#tabelJenispegawai').DataTable().ajax.reload(null, false);
                $('#simpan').text('Save');
